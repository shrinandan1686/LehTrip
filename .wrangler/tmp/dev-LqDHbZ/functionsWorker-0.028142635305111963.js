...
// .wrangler/tmp/bundle-BclDqa/checked-fetch.js
...
// .wrangler/tmp/pages-NbzgYg/functionsWorker-0.028142635305111963.mjs
...
async function onRequestGet3({ env }) {
  try {
    const [entriesResult, notesResult] = await Promise.all([
      env.DB.prepare(
        "SELECT id, day_id, description, category, who, amount FROM entries ORDER BY created_at ASC"
      ).all(),
...
// .wrangler/tmp/bundle-BclDqa/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-BclDqa/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.028142635305111963.js.map
